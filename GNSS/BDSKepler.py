...
#import Core
# from Core import bdt2gpsw
#import GNSS
from GNSS import BDS
import numpy as np
from time_transform.time_format import BdsTime
...
class BDSKepler():
    ...
    def res(self):
        ...
        #t = self.tTagArr
        #tk = t - bdt2gpsw.bdt2gpsw(Toe_Week,Toe_SOW)[1]  # Time from ephemeris reference epoch
        Rollover = BdsTime().Rollover
        toc = [BdsTime([Toe_Week[i],Toe_SOW[i],Rollover]).BDS2GPS().datetime 
...
#         tk[ind1] = t[ind1] - bdt2gpsw.bdt2gpsw(Toe_Week,Toe_SOW)[1][ind1] - 604800.0
#         tk[ind2] = t[ind2] - bdt2gpsw.bdt2gpsw(Toe_Week,Toe_SOW)[1][ind2] + 604800.0
#         tk[ind3] = t[ind3] - bdt2gpsw.bdt2gpsw(Toe_Week,Toe_SOW)[1][ind3]
# =============================================================================
        ...
        # Clock and ClockRate
        clk  = bias + drift * tk + driftRate * tk**2
